...
public static class Localization
{
        ...
        new Dictionary<string, (string, string)>
    {
        ...
        ["MacBlurOpacityHint"] = ("macOS blur keeps the background layer at 0% opacity. Text outlines and control surfaces preserve readability over the desktop.", "macOS 毛玻璃会自动将背景层不透明度设为 0%；文字描边和控件底色确保透出桌面时仍清晰可读。"),
