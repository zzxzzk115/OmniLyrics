...
public static class Localization
{
        ...
        new Dictionary<string, (string, string)>
    {
        ...
        ["YesPlayMusicFavoritesHint"] = ("Favorites use the local Web API first; no API token is needed. If it reports no signed-in session, optionally scan with NetEase Cloud Music using the same account as the player.", "收藏优先使用本地 Web API，无需填写 API Token。只有接口报告未登录时，才需要用网易云音乐手机 App 扫码，授权与播放器相同的账号。"),
        ["AuthorizeSpotify"] = ("Save and authorize in browser", "保存并在浏览器授权"),
        ["AuthorizeYesPlayMusic"] = ("Sign in with QR code", "扫码登录"),
        ...
        ["YesPlayMusicLocalFirst"] = ("Using the local Web API. Check access before adding separate authorization.", "优先使用本地 Web API；可先检测访问状态，无需预先配置授权。"),
        ...
        ["YesPlayMusicWaiting"] = ("Connecting… Scan the QR code with NetEase Cloud Music and confirm sign-in.", "正在连接… 请使用网易云音乐扫描二维码并确认登录。"),
