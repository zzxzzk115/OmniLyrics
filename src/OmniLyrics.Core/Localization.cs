...
public static class Localization
{
        ...
        new Dictionary<string, (string, string)>
    {
        ...
        ["YesPlayMusicFavoritesHint"] = ("Keep YesPlayMusic running, then scan with the NetEase Cloud Music mobile app. Use the same account as the player. OmniLyrics stores its own authorization.", "保持 YesPlayMusic 运行，使用网易云音乐手机 App 扫码，并登录与播放器相同的账号。OmniLyrics 单独保存这次授权。"),
